...
import { getTicketById, addTicketResponse, updateTicketStatus } from '../services/api';
        ...
        <div className="bg-red-50 border-l-4 border-red-400 p-4">
          <div className="flex">
            ...
            <div className="ml-3">
              ...
              <div className="mt-2">
                <Link to="/admin/support" className="text-sm font-medium text-red-700 hover:text-red-600">
                  Go back to support tickets
                </Link>
              </div>
            </div>
          </div>
        ...
        <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4">
          <div className="flex">
            ...
            <div className="ml-3">
              ...
              <div className="mt-2">
                <Link to="/admin/support" className="text-sm font-medium text-yellow-700 hover:text-yellow-600">
                  Go back to support tickets
                </Link>
              </div>
            </div>
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-6">
        <div className="flex justify-between items-center">
          <div>
            <Link to="/admin/support" className="text-emerald-600 hover:text-emerald-900 flex items-center">
              <svg className="h-5 w-5 mr-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                <path fillRule="evenodd" d="M9.707 16.707a1 1 0 01-1.414 0l-6-6a1 1 0 010-1.414l6-6a1 1 0 011.414 1.414L5.414 9H17a1 1 0 110 2H5.414l4.293 4.293a1 1 0 010 1.414z" clipRule="evenodd" />
              </svg>
              Back to Support Tickets
            </Link>
            <h1 className="text-2xl font-bold text-gray-900 mt-2">{ticket.subject}</h1>
          </div>
        ...
        <div className="px-4 py-5 sm:px-6">
          <div className="flex justify-between">
            <div>
              ...
              <p className="mt-1 max-w-2xl text-sm text-gray-500">Details about the support ticket.</p>
            </div>
                    ...
                    <div className={`max-w-lg rounded-lg px-4 py-3 ${response.isAdmin ? 'bg-gray-100' : 'bg-emerald-100'}`}>
                      <div className="flex items-center mb-1">
                        <span className="font-medium text-sm">
                          {response.isAdmin ? 'Support Agent' : ticket.user?.name || 'User'}
                        </span>
