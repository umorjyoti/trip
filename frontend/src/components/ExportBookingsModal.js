...
const ExportBookingsModal = ({ isOpen, onClose, onExport }) => {
  ...
  const fields = [
    ...
    { id: "trekName", label: "Trek Name" },
    { id: "batchDate", label: "Batch Date" },
    { id: "userName", label: "User Name" },
    { id: "userEmail", label: "User Email" },
    { id: "userPhone", label: "User Phone" },
